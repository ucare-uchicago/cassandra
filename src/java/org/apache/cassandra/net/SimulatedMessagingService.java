...
public final class SimulatedMessagingService implements MessagingServiceMBean
{
...
//    }
    ...
    private static final Logger logger = LoggerFactory.getLogger(SimulatedMessagingService.class);
...
//    	logger.info("korn validating magic");
    ...
    public Integer getVersion(InetAddress address)
    {
        ...
        if (v == null)
        {
            ...
            return SimulatedMessagingService.current_version;
        }
        else
            return v;
    }
